...
- Gran soporte en servidores  
- Filosofía 100% FOSS

Cuándo usar Debian:  
- Servidores  
- Sistemas críticos  
- Estaciones de trabajo donde la estabilidad importa más que la novedad  
- Bases para crear tu propia distro
...
- elementaryOS  
- Zorin OS  
- Kubuntu, Xubuntu, Lubuntu, Ubuntu Budgie, Ubuntu Studio, etc.
...
*Si quieres facilidad y productividad*
→ Ubuntu, Linux Mint, Pop!_OS

*Si quieres ligereza*
→ antiX, MX Linux, Lubuntu, Peppermint

*Si quieres seguridad ofensiva*
→ Kali, Parrot

*Si quieres privacidad extrema*
→ Tails

*Si quieres creatividad y multimedia*
→ Ubuntu Studio
