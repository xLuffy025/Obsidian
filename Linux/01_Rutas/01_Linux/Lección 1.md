...
## 🎯 Objetivo
-  Aprender a instalar Linux en WSL (Windows) y TERMUX(proot-distro) en Android y en
...
Los comandos básicos de Bash permiten moverse y manipular archivos y carpetas:
