 Aquí tienes una guía completa y estructurada sobre printf, lista para que la copies y pegues directamente en tu bóveda de Obsidian.
🖨️ Comando printf en Bash
...
(Nota: printf no añade un salto de línea automáticamente. Siempre debes incluir \n al final si quieres pasar a la siguiente línea).
...
| %b | Cadena que interpreta secuencias de escape (ideal para variables con colores como \e[36m). | printf "%bTexto%b\n" "$CYAN" "$RESET" | Texto (en color cyan) |
