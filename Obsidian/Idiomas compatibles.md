Esta es la lista de los 297 idiomas compatibles actualmente con Prism, con su alias correspondiente, para usar en lugar de xxxx en la clase language-xxxx (o lang-xxxx):
